...
class Dataset:
    ...
    def training_dataset(self) -> TrainingDataset:
        training_dataset, training_template  = split(
            self.gluonts_dataset, offset=-self.prediction_length * (self.windows + 1)
        )
        
        train_data = training_template.generate_instances(
    ...
    def validation_dataset(self) -> TrainingDataset:
        validation_dataset, validation_template = split(
        ...
        return validation_data #validation_dataset
