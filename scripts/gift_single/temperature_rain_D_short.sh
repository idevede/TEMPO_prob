#!/bin/bash
#SBATCH --job-name="temperature_rain_D_short"
#SBATCH --output="logs/gift_dec_log_prob/temperature_rain_D_short.%j.%N.out"
...
for data_name in temperature_rain_D_short 
do
...
torchrun --nproc_per_node=2 --master_port=29759  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
