#!/bin/bash
#SBATCH --job-name="m4_quarterly_Q_short"
#SBATCH --output="logs/gift_dec_log_prob/m4_quarterly_Q_short.%j.%N.out"
...
for data_name in m4_quarterly_Q_short 
do
...
torchrun --nproc_per_node=2 --master_port=29738  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
