#!/bin/bash
#SBATCH --job-name="solar_D_short"
#SBATCH --output="logs/gift_dec_log_prob/solar_D_short.%j.%N.out"
...
for data_name in solar_D_short 
do
...
torchrun --nproc_per_node=1 --master_port=29724  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
