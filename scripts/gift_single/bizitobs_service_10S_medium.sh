...
#SBATCH --output="logs/gift_dec_log_prob/bizitobs_service_10S_medium.%j.%N.out"
...
torchrun --nproc_per_node=2 --master_port=29673  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
