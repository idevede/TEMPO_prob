#!/bin/bash
#SBATCH --job-name="m4_yearly_A_short"
#SBATCH --output="logs/gift_dec_log_prob/m4_yearly_A_short.%j.%N.out"
...
for data_name in m4_yearly_A_short 
do
...
torchrun --nproc_per_node=2 --master_port=29731  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
