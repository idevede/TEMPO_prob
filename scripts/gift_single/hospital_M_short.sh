#!/bin/bash
#SBATCH --job-name="hospital_M_short"
#SBATCH --output="logs/gift_dec_log_prob/hospital_M_short.%j.%N.out"
...
for data_name in hospital_M_short 
do
...
torchrun --nproc_per_node=2 --master_port=29720  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
