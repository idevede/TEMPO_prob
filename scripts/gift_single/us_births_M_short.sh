#!/bin/bash
#SBATCH --job-name="us_births_M_short"
#SBATCH --output="logs/gift_dec_log_prob/us_births_M_short.%j.%N.out"
...
for data_name in us_births_M_short 
do
...
torchrun --nproc_per_node=2 --master_port=29730  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
