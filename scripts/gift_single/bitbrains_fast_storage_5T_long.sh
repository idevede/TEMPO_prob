...
#SBATCH --output="logs/gift_dec_log_prob/bitbrains_fast_storage_5T_long.%j.%N.out"
...
torchrun --nproc_per_node=2 --master_port=29740  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
