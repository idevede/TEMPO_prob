#!/bin/bash
#SBATCH --job-name="car_parts_M_short"
#SBATCH --output="logs/gift_dec_log_prob/car_parts_M_short.%j.%N.out"
...
for data_name in car_parts_M_short 
do
...
torchrun --nproc_per_node=2 --master_port=29736  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
