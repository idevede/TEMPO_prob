#!/bin/bash
#SBATCH --job-name="ett2_W_short"
#SBATCH --output="logs/gift_dec_log_prob/ett2_W_short.%j.%N.out"
...
torchrun --nproc_per_node=1 --master_port=29732  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
