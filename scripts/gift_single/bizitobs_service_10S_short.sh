...
#SBATCH --output="logs/gift_dec_log_prob/bizitobs_service_10S_short.%j.%N.out"
...
torchrun --nproc_per_node=1 --master_port=29744  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
