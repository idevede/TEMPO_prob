#!/bin/bash
#SBATCH --job-name="hierarchical_sales_W_short"
#SBATCH --output="logs/gift_dec_log_prob/hierarchical_sales_W_short.%j.%N.out"
...
for data_name in hierarchical_sales_W_short 
do
...
torchrun --nproc_per_node=2 --master_port=29737  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
