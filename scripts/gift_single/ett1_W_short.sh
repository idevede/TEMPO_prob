#!/bin/bash
#SBATCH --job-name="ett1_W_short"
#SBATCH --output="logs/gift_dec_log_prob/ett1_W_short.%j.%N.out"
...
torchrun --nproc_per_node=2 --master_port=29735  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
