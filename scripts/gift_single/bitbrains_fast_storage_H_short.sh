#!/bin/bash
#SBATCH --job-name="bitbrains_fast_storage_H_short"
#SBATCH --output="logs/gift_dec_log_prob/bitbrains_fast_storage_H_short.%j.%N.out"
...
for data_name in bitbrains_fast_storage_H_short 
do
...
torchrun --nproc_per_node=1 --master_port=29733  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
