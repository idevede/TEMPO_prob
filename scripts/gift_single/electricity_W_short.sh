#!/bin/bash
#SBATCH --job-name="electricity_W_short"
#SBATCH --output="logs/gift_dec_log_prob/electricity_W_short.%j.%N.out"
...
for data_name in electricity_W_short 
do
...
torchrun --nproc_per_node=1 --master_port=29739  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
