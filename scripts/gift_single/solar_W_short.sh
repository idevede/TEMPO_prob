#!/bin/bash
#SBATCH --job-name="solar_W_short"
#SBATCH --output="logs/gift_dec_log_prob/solar_W_short.%j.%N.out"
...
for data_name in solar_W_short 
do
...
torchrun --nproc_per_node=2 --master_port=29721  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
