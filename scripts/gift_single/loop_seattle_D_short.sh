#!/bin/bash
#SBATCH --job-name="loop_seattle_D_short"
#SBATCH --output="logs/gift_dec_log_prob/loop_seattle_D_short.%j.%N.out"
...
for data_name in loop_seattle_D_short 
do
...
torchrun --nproc_per_node=2 --master_port=29725  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
