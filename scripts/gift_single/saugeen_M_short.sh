#!/bin/bash
#SBATCH --job-name="saugeen_M_short"
#SBATCH --output="logs/gift_dec_log_prob/saugeen_M_short.%j.%N.out"
...
for data_name in saugeen_M_short 
do
...
torchrun --nproc_per_node=1 --master_port=29728  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
