#!/bin/bash
#SBATCH --job-name="electricity_15T_medium"
#SBATCH --output="logs/gift_dec_log/electricity_15T_medium.%j.%N.out"
...
for data_name in electricity_15T_medium 
do
...
torchrun --nproc_per_node=2 --master_port=29525  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
