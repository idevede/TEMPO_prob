#!/bin/bash
#SBATCH --job-name="ett2_15T_medium"
#SBATCH --output="logs/gift_dec_log/ett2_15T_medium.%j.%N.out"
...
for data_name in ett2_15T_medium 
do
...
torchrun --nproc_per_node=2 --master_port=29626  train_TEMPO_parallel_single_data_prob.py \
    --datasets $data_name \
    --eval_data $data_name \
