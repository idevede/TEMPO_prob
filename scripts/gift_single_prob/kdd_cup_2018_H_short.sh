#!/bin/bash
#SBATCH --job-name="kdd_cup_2018_H_short"
#SBATCH --output="logs/gift_dec_log/kdd_cup_2018_H_short.%j.%N.out"
...
for data_name in kdd_cup_2018_H_short 
do
...
torchrun --nproc_per_node=2 --master_port=29629  train_TEMPO_parallel_single_data_prob.py \
    --datasets $data_name \
    --eval_data $data_name \
