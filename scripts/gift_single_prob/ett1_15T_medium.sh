#!/bin/bash
#SBATCH --job-name="ett1_15T_medium"
#SBATCH --output="logs/gift_dec_log/ett1_15T_medium.%j.%N.out"
...
for data_name in ett1_15T_medium 
do
...
torchrun --nproc_per_node=2 --master_port=29665  train_TEMPO_parallel_single_data_prob.py \
    --datasets $data_name \
    --eval_data $data_name \
