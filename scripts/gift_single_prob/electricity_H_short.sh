#!/bin/bash
#SBATCH --job-name="electricity_H_short"
#SBATCH --output="logs/gift_dec_log/electricity_H_short.%j.%N.out"
...
for data_name in electricity_H_short 
do
...
torchrun --nproc_per_node=2 --master_port=29520  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
