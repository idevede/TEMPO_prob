#!/bin/bash
#SBATCH --job-name="bizitobs_application_10S_medium"
#SBATCH --output="logs/gift_dec_log/bizitobs_application_10S_medium.%j.%N.out"
...
for data_name in bizitobs_application_10S_medium 
do
...
echo logs/gift_dec/$data_name'_'$seq_len.log

torchrun --nproc_per_node=2 --master_port=29671  train_TEMPO_parallel_single_data_prob.py \
    --datasets $data_name \
    --eval_data $data_name \
    ...
    --loss_func prob >> logs/gift_dec/$data_name'_'$seq_len.log
