#!/bin/bash
#SBATCH --job-name="saugeen_D_short"
#SBATCH --output="logs/gift_dec_log/saugeen_D_short.%j.%N.out"
...
for data_name in saugeen_D_short 
do
...
torchrun --nproc_per_node=2 --master_port=29632  train_TEMPO_parallel_single_data_prob.py \
    --datasets $data_name \
    --eval_data $data_name \
