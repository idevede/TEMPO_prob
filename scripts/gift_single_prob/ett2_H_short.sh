#!/bin/bash
#SBATCH --job-name="ett2_H_short"
#SBATCH --output="logs/gift_dec_log/ett2_H_short.%j.%N.out"
...
torchrun --nproc_per_node=2 --master_port=29648  train_TEMPO_parallel_single_data_prob.py \
    --datasets $data_name \
    --eval_data $data_name \
