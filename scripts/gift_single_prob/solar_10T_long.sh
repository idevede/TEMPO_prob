#!/bin/bash
#SBATCH --job-name="solar_10T_long"
#SBATCH --output="logs/gift_dec_log/solar_10T_long.%j.%N.out"
...
for data_name in solar_10T_long 
do
...
torchrun --nproc_per_node=2 --master_port=29634  train_TEMPO_parallel_single_data_prob.py \
    --datasets $data_name \
    --eval_data $data_name \
