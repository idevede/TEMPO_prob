#!/bin/bash
#SBATCH --job-name="jena_weather_10T_short"
#SBATCH --output="logs/gift_dec_log/jena_weather_10T_short.%j.%N.out"
...
for data_name in jena_weather_10T_short 
do
...
torchrun --nproc_per_node=2 --master_port=29580  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
