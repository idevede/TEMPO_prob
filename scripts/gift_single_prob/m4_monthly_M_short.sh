#!/bin/bash
#SBATCH --job-name="m4_monthly_M_short"
#SBATCH --output="logs/gift_dec_log/m4_monthly_M_short.%j.%N.out"
...
for data_name in m4_monthly_M_short 
do
...
torchrun --nproc_per_node=2 --master_port=29637  train_TEMPO_parallel_single_data_prob.py \
    --datasets $data_name \
    --eval_data $data_name \
