#!/bin/bash
#SBATCH --job-name="us_births_W_short"
#SBATCH --output="logs/gift_dec_log/us_births_W_short.%j.%N.out"
...
for data_name in us_births_W_short 
do
...
torchrun --nproc_per_node=2 --master_port=29635  train_TEMPO_parallel_single_data_prob.py \
    --datasets $data_name \
    --eval_data $data_name \
