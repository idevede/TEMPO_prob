#!/bin/bash
#SBATCH --job-name="loop_seattle_H_short"
#SBATCH --output="logs/gift_dec_log/loop_seattle_H_short.%j.%N.out"
...
for data_name in loop_seattle_H_short 
do
...
torchrun --nproc_per_node=2 --master_port=29550  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
