#!/bin/bash
#SBATCH --job-name="ett1_D_short"
#SBATCH --output="logs/gift_dec_log/ett1_D_short.%j.%N.out"
...
torchrun --nproc_per_node=2 --master_port=29669  train_TEMPO_parallel_single_data_prob.py \
    --datasets $data_name \
    --eval_data $data_name \
