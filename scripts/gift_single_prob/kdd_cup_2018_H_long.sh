#!/bin/bash
#SBATCH --job-name="kdd_cup_2018_H_long"
#SBATCH --output="logs/gift_dec_log/kdd_cup_2018_H_long.%j.%N.out"
...
for data_name in kdd_cup_2018_H_long 
do
...
torchrun --nproc_per_node=2 --master_port=29631  train_TEMPO_parallel_single_data_prob.py \
    --datasets $data_name \
    --eval_data $data_name \
