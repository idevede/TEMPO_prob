#!/bin/bash
#SBATCH --job-name="bizitobs_service_10S_short"
#SBATCH --output="logs/gift_dec_log/bizitobs_service_10S_short.%j.%N.out"
...
for data_name in bizitobs_service_10S_short 
do
...
torchrun --nproc_per_node=2 --master_port=29588  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
