#!/bin/bash
#SBATCH --job-name="bizitobs_service_10S_medium"
#SBATCH --output="logs/gift_dec_log/bizitobs_service_10S_medium.%j.%N.out"
...
for data_name in bizitobs_service_10S_medium 
do
...
torchrun --nproc_per_node=2 --master_port=29673  train_TEMPO_parallel_single_data_prob.py \
    --datasets $data_name \
    --eval_data $data_name \
