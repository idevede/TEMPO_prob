#!/bin/bash
#SBATCH --job-name="jena_weather_H_long"
#SBATCH --output="logs/gift_dec_log/jena_weather_H_long.%j.%N.out"
...
for data_name in jena_weather_H_long 
do
...
torchrun --nproc_per_node=2 --master_port=29676  train_TEMPO_parallel_single_data_prob.py \
    --datasets $data_name \
    --eval_data $data_name \
