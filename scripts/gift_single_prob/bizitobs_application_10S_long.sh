#!/bin/bash
#SBATCH --job-name="bizitobs_application_10S_long"
#SBATCH --output="logs/gift_dec_log/bizitobs_application_10S_long.%j.%N.out"
...
for data_name in bizitobs_application_10S_long 
do
...
torchrun --nproc_per_node=2 --master_port=29672  train_TEMPO_parallel_single_data_prob.py \
    --datasets $data_name \
    --eval_data $data_name \
