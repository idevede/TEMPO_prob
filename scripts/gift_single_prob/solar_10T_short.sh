#!/bin/bash
#SBATCH --job-name="solar_10T_short"
#SBATCH --output="logs/gift_dec_log/solar_10T_short.%j.%N.out"
...
for data_name in solar_10T_short 
do
...
torchrun --nproc_per_node=2 --master_port=29540  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
