#!/bin/bash
#SBATCH --job-name="jena_weather_10T_medium"
#SBATCH --output="logs/gift_dec_log/jena_weather_10T_medium.%j.%N.out"
...
for data_name in jena_weather_10T_medium 
do
...
torchrun --nproc_per_node=2 --master_port=29581  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
