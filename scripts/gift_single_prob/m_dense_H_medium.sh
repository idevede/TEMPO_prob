#!/bin/bash
#SBATCH --job-name="m_dense_H_medium"
#SBATCH --output="logs/gift_dec_log/m_dense_H_medium.%j.%N.out"
...
for data_name in m_dense_H_medium 
do
...
torchrun --nproc_per_node=2 --master_port=29639  train_TEMPO_parallel_single_data_prob.py \
    --datasets $data_name \
    --eval_data $data_name \
