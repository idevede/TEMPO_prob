#!/bin/bash
#SBATCH --job-name="saugeen_W_short"
#SBATCH --output="logs/gift_dec_log/saugeen_W_short.%j.%N.out"
...
for data_name in saugeen_W_short 
do
...
torchrun --nproc_per_node=2 --master_port=29641  train_TEMPO_parallel_single_data_prob.py \
    --datasets $data_name \
    --eval_data $data_name \
