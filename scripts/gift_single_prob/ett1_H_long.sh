#!/bin/bash
#SBATCH --job-name="ett1_H_long"
#SBATCH --output="logs/gift_dec_log/ett1_H_long.%j.%N.out"
...
torchrun --nproc_per_node=2 --master_port=29653  train_TEMPO_parallel_single_data_prob.py \
    --datasets $data_name \
    --eval_data $data_name \
