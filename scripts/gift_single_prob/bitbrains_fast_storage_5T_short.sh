#!/bin/bash
#SBATCH --job-name="bitbrains_fast_storage_5T_short"
#SBATCH --output="logs/gift_dec_log/bitbrains_fast_storage_5T_short.%j.%N.out"
...
for data_name in bitbrains_fast_storage_5T_short 
do
...
torchrun --nproc_per_node=2 --master_port=29560  train_TEMPO_parallel_single_data.py \
    --datasets $data_name \
    --eval_data $data_name \
