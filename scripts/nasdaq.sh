...
seq_len=168
model=NeuralCDE #GPT4TS #PatchTST #GPT4TS #PatchTST #DLinear #PatchTST #DLinear #PatchTST #DLinear #TEMPO #PatchTST 
...
python main_multi_6domain_release.py \
    ...
    --model_id nasdaq_$model'_'$gpt_layer'_'prompt_learn'_'$seq_len'_'$pred_len'_'$percent \
