...
#SBATCH --output="logs/gift_dec_log_prob/m_dense_D_short.%j.%N.out"
...
for data_name in m_dense_D_short 
do
...
torchrun --nproc_per_node=2 --master_port=29529  train_TEMPO_parallel_single_data_prob.py \
    --datasets $data_name \
    --eval_data $data_name \
    ...
    --loss_func prob >> logs/gift_dec_prob/$data_name'_'$seq_len.log
