...
seq_len=96
model=NeuralCDE #PatchTST #PatchTST #PatchTST #GPT4TS #PatchTST #DLinear #PatchTST #DLinear #PatchTST #DLinear #TEMPO #PatchTST 
...
python main_multi_6domain_release.py \
    ...
    --model_id physionet_$model'_'$gpt_layer'_'prompt_learn'_'$seq_len'_'$pred_len'_'$percent \
